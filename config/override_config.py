...
override_config = {
    ...
    VideoConstants.video_12_ManchesterCity_Sevilla_66_74: {
        'vanishing_point_finder': {
                'method': 'hough',
                'hough': {
                    'vp_segments_first_frame': [[(411, 1039), (1305, 306)], [(1148, 1075), (1641, 323)]]  # Not detecting anything on this video. Tweak other parameters
                }
        }
    },
    ...
    VideoConstants.video_15_Valencia_Getafe_38_52: {
        'vanishing_point_finder': {
                'method': 'hough',
                'hough': {
                    'vp_segments_first_frame': [[(944, 1046), (930, 276)], [(1561, 1044), (1262, 491)]]  # Not detecting anything on this video. Tweak other parameters
                }
        }
    },
    ...
    VideoConstants.video_18_Sevilla_Valladolid_29_38: {
        'vanishing_point_finder': {
                'method': 'hough',
                'hough': {
                    'vp_segments_first_frame': [[(750, 1043), (737, 365)], [(174, 1029), (527, 400)]]  # Not detecting anything on this video. Tweak other parameters
                }
        }
    },
    ...
    VideoConstants.video_21_Roma_Ludogrets_503_510: {
        'vanishing_point_finder': {
                'method': 'hough',
                'hough': {
                    'vp_segments_first_frame': [[(896, 998), (1165, 200)], [(1461, 1026), (1469, 202)]]  # Not detecting anything on this video. Tweak other parameters
                }
        }
    },
    VideoConstants.video_22_ManchesterCity_Brighton_539_547: {
        'vanishing_point_finder': {
                'method': 'hough',
                'hough': {
                    'vp_segments_first_frame': [[(426, 963), (1116, 85)], [(1028, 938), (1396, 52)]]  # Not detecting very well on this video. Tweak other parameters
                }
        }
    },
}
